...
const InspectionTables = () => {
  ...
  const rows = inspectionReports.map((entry) => (
    <tr key={entry.serviceOrder}>
      ...
      <td>
        {entry.dateTime.toLocaleDateString("en-US", {
          month: "numeric",
          day: "numeric",
          year: "numeric",
        })}
      ...
      <td>
        {entry.acknowledged ? (
          <ThemeIcon variant="outline" radius="md" size="sm" color="green">
            <Check />
          </ThemeIcon>
        ) : (
          <ThemeIcon variant="outline" radius="md" size="sm" color="red">
            <X />
          </ThemeIcon>
        )}
      </td>
...
const SummaryDevices = () => {
  ...
  const rows = deviceSummary.map((entry) => (
    <tr key={entry.deviceCode}>
      ...
      <td>
        {entry.dateDeployed.toLocaleDateString("en-US", {
          month: "numeric",
          day: "numeric",
          year: "numeric",
        })}
  ...
  return (
    <>
      <Group>
        ...
        <MultiSelect data={dummyQuery.areas} placeholder="Area" />
        <MultiSelect data={dummyQuery.deviceTypes} placeholder="Device Type" />
        <MultiSelect
...
const Reports = () => {
  return (
    <Paper shadow="md" p="sm" my="md">
      ...
      <Tabs>
        <Tabs.Tab label="Inspection Reports">
          <InspectionTables />
        </Tabs.Tab>
        ...
        <Tabs.Tab label="Summary of Devices">
          <SummaryDevices />
        </Tabs.Tab>
      </Tabs>
    </Paper>
