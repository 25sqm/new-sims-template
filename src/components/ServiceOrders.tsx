                ...
                >
                  <Group spacing="sm" grow>
                    ...
                    <Group direction="row" spacing="xs">
                      <Tooltip label="View Report" radius="xs" withArrow>
                        <Button size="xs">
                          <Pencil size={15} />
                        </Button>
                      </Tooltip>
              ...
              upcomingServiceData.map((entry) => (
                ...
                >
                  <Group spacing="sm" grow>
                    ...
                    <Text size="sm">{entry.serviceOrder}</Text>
                    <Button size="xs" leftIcon={<Pencil size={15} />}>
                      View Report
                    </Button>
                  </Group>
                </Box>
              ...
              pastService.map((entry) => (
                ...
                >
                  <Group spacing="sm" grow>
                    ...
                    <Text size="sm">{entry.serviceOrder}</Text>
                    <Button size="xs" leftIcon={<ClearAll size={15} />}>
                      Clear Order
                    </Button>
                  </Group>
                </Box>
